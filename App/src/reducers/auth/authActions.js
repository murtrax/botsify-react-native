...
const {
  ...
  DELETE_USER_ID_REQUEST,
  DELETE_USER_ID_SUCCESS,
...
export function logout () {
  return dispatch => {
    ...
    return appAuthToken.getSessionToken()
      ...
      .then(() => {
        console.log(appAuthToken.getSessionToken())
        dispatch(loginState())
        dispatch(logoutSuccess())
        dispatch(deleteSessionToken())
        // console.log(appAuthToken.getSessionUserId())
        // dispatch(deleteSessionUserId())
 ...
 * ## DeleteToken actions
 */
export function deleteUserIdRequest () {
  return {
    type: DELETE_USER_ID_REQUEST
  }
}
export function deleteUserIdRequestSuccess () {
  return {
 ...
 * Call the AppAuthToken deleteSessionToken
 */
export function deleteSessionUserId () {
  return dispatch => {
    dispatch(deleteUserIdRequest())
    return appAuthToken.deleteSessionUserId()
      .then(() => {
        dispatch(deleteUserIdRequestSuccess())
      })
  }
}
/**
 ...
 * @param {Object} json - object with sessionToken
 */
export function saveSessionUserId (json) {
  return appAuthToken.storeSessionUserId(json)
}
/**
 * ## signup
      ...
      .then(function (json) {
        return saveSessionToken(json.token)
          .then(function () {
            ...
            saveSessionUserId(json.user.id)
            // navigate to Tabbar
            Actions.Tabbar()
            dispatch(logoutState())
          })
